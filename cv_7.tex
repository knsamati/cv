...
\firstname{Komlan Nouwokpo} % Your first name
\familyname{SAMATI} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae}
\address{123 Broadway}{City, State 12345}
\mobile{(+228) 91 85 06 28}
\phone{(+228) 97 10 19 40}
%\fax{(000) 111 1113}
\email{kn.samati@gmail.com}
\homepage{knsamati.github.io}{knsamati.github.io} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
